...
import 'package:sockets2/src/pages/creargrupo_page.dart';
import 'package:sockets2/src/pages/forgotpass_page.dart';
...
Map<String, WidgetBuilder> getApplicationRoutes(){
  return <String, WidgetBuilder>{
    ...
    'home'       : ( BuildContext context) => ControllerPage(),
    'creargrupo' : ( BuildContext context) => CrearGrupoPage(),
  };
}